  ...
  return (
    <section className="home-content about-page">
      <div className="about-container">
        ...
        <p>
          Cây cảnh được thành lập với niềm đam mê bất tận dành cho cây xanh và mong muốn mang thiên nhiên vào không gian sống của mỗi người Việt. Chúng tôi tin rằng, một chút màu xanh không chỉ làm đẹp thêm ngôi nhà, văn phòng mà còn là liệu pháp tinh thần tuyệt vời.
        </p>
