      ...
      <div className="mx-auto grid max-w-5xl overflow-hidden rounded-[2rem] bg-white shadow-[0_30px_80px_rgba(15,23,42,0.08)] lg:grid-cols-[0.95fr_1.05fr]">
        <div className="bg-[linear-gradient(150deg,_#052e16,_#065f46_55%,_#d1fae5)] p-8 text-white sm:p-12">
          ...
          <p className="mt-5 max-w-md text-base leading-7 text-emerald-50/90">
            Tính năng này đã được nối với API `PUT /api/user/me/password`. Backend sẽ kiểm tra mật khẩu hiện tại trước khi cập nhật mật khẩu mới.
          </p>
        </div>

        <div className="p-8 sm:p-12">
          <h2 className="text-3xl font-semibold text-slate-900">Đổi mật khẩu</h2>
          <p className="mt-3 text-sm leading-6 text-slate-500">Nhập chính xác mật khẩu hiện tại và mật khẩu mới theo đúng quy tắc backend đang validate.</p>
