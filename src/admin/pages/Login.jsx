          ...
          <div className="relative h-full flex flex-col justify-between text-white z-20">
            <div>
              <div className="flex items-center space-x-3 mb-8">
                ...
                <span className="text-2xl font-black tracking-tighter">Trang Quản Lý</span>
              </div>
              <h1 className="text-5xl font-black leading-tight mb-4">Quản lý hệ thống <br /> Cây Cảnh chuyên nghiệp</h1>
              <p className="text-white/80 font-medium text-lg max-w-md">Hệ thống tối ưu hóa quy trình bán hàng và chăm sóc khách hàng cho cửa hàng Cây Cảnh của bạn.</p>
            </div>
        ...
        <div className="w-full md:w-1/2 p-12 md:p-20 bg-white">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <button type="button" className="text-sm font-black text-primary hover:underline">
                Quên mật khẩu?
              </button>
            </div>
